...
import 'package:kamera_filter/widget/filter_item.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: ListView.builder(
        key: const ValueKey('filter_listview'),
        ...
        itemBuilder: (context, index) {
          ...
          return GestureDetector(
            key: ValueKey('filter_gesture_$index'),
            onTap: () => _onFilterTapped(index),
            child: Container(
              key: ValueKey('filter_container_$index'),
              width: size,
              height: size,
              ...
              child: ClipOval(
                child: FilterItem(
                  key: ValueKey('filter_item_$index'),
